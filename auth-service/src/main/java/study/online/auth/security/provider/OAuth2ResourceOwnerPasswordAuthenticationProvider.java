...
import study.online.auth.security.token.OAuth2ResourceOwnerPasswordAuthenticationToken;
...
public class OAuth2ResourceOwnerPasswordAuthenticationProvider implements AuthenticationProvider {
	...
	public boolean supports(Class<?> authentication) {
		...
		LOGGER.debug("supports authentication={} returning {}", authentication, supports);
		return supports;
	}
