package study.online.captcha.service;
 ...
 */
@Slf4j
public abstract class AbstractCheckCodeService implements ICheckCodeService {
     ...
     * @date 2022/9/30 6:07
    */
    public GenerateResult generate(Integer code_length, String keyPrefix, Integer expire){
        //生成四位验证码
